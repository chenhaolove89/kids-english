...
- **学英语**：1998 单词 / 53 分类（动物、野生动物、家人、食物、国家国旗、太空、职业、常用词、词族拼读……），看图学词 + 听音选图挑战 + 分类韵律 chant 🎵
...
> 五六年级数学当前没有已开放关卡，古诗已覆盖全部四学段（启蒙 12 首、其余三学段各 6 首）。176 门课程中 173 门 `available`、3 门 `draft`：
